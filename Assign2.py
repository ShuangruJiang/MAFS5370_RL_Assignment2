...
# =============================================================================
# 12x12 Pyramid Board Definition
# =============================================================================
BLOCKS = [
    (0, 4, 4, 8),    # Level 1
...
if __name__ == "__main__":
    ...
    torch.save(q_net.state_dict(), "pyramid_dqn_torchrl_stochastic_fix.pt")
    print("Saved model to pyramid_dqn_torchrl_stochastic_fix.pt")
